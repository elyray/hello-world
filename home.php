...
<div class ="form-group row">
   ...
   <p class=" text-white">Living a healthy lifestyle is not just a fad. For some, it's a way of life.
                   ...
                   <p class=" text-white">At The Gym we want you to exercise your options to suit your needs. Whether you want to trim down or tone up, have more energy for your family, for work, or for play, or to just look and feel better.</p><img src ="image/workout.png" width="800" height="400">
                    </div>
...
<div class = "form-group row">
      <div class="col-lg-1"></div>
            ...
            <div class="col-lg-2"></div>
            <div class="col-lg-2"><img src ="image/grouptraining.jpg" width="270" height="200"></div>
           <div class="col-lg-1"></div>
            <div class="col-lg-2"><img src ="image/personaltraining.jpg" width="270" height="200"></div>
           <br>
    </div>
<br><br>
<div class = "form-group row">
