  ...
  <div class = "form-row"  style="background-color: black;">
      <div class="col-sm-2">
            ...
            <div class="col-sm-2">
               ...
               <div class="col-sm-2">
                <a class="btn btn-dark btn-lg btn-block" href="myAcc.php" role="button" style="background-color: black;">MY ACCOUNT</a>
                </div>

            <div class="col-sm-2">
                <a class="btn btn-dark btn-lg btn-block" href="logout.php" role="button" style="background-color: black;">LOG-OUT</a>
                    </div>
