...
<div class = "row">
 <div class="col-lg-1" style="background-color: black;" ></div>
      <div class="col-lg-3">
      <br> <br> <br> 
      <label><h3>Forgot Password</h3></label><br>
      ...
      <br><br><br>
       ...
       <button type="reset" class="btn btn-dark btn-lg" >Cancel</button><br><br>
        <br> <br>
       </div>
           <br>
             <div class="col-lg-2"><br> <img src ="image/workout.png" width="650" height="350"></div>
